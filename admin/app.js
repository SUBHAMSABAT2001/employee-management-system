const API_URL = 'https://zfa8n0fvka.execute-api.us-east-1.amazonaws.com/production';  
...
function deleteInfo(employeeId) {    
    if (confirm("Are you sure you want to delete?")) {    
        const apiUrl = `https://zfa8n0fvka.execute-api.us-east-1.amazonaws.com/production/employee`;    
